...
class CombinedOrchestrator:
    ...
    def run_tests(self) -> None:
        ...
        if self.dev_pyats_only:
            typer.secho("⚠️  WARNING: --pyats flag is for development use only. Production runs should use combined execution.", fg=typer.colors.YELLOW)
    ...
    def _print_execution_summary(self, has_pyats: bool, has_robot: bool) -> None:
        ...
        if has_robot:
            ...
            if not self.render_only:
                typer.echo(f"   📊 Reports: {self.output_dir}/robot_results/report.html")
