...
[ -n \"\$NAC_TEST_SENTINEL_TIMEOUT\" ] && echo \"NAC_TEST_SENTINEL_TIMEOUT=\$NAC_TEST_SENTINEL_TIMEOUT\" || echo 'NAC_TEST_SENTINEL_TIMEOUT=(not set)'
[ -n \"\$NAC_TEST_PIPE_DRAIN_DELAY\" ] && echo \"NAC_TEST_PIPE_DRAIN_DELAY=\$NAC_TEST_PIPE_DRAIN_DELAY\" || echo 'NAC_TEST_PIPE_DRAIN_DELAY=(not set)'
[ -n \"\$NAC_TEST_PIPE_DRAIN_TIMEOUT\" ] && echo \"NAC_TEST_PIPE_DRAIN_TIMEOUT=\$NAC_TEST_PIPE_DRAIN_TIMEOUT\" || echo 'NAC_TEST_PIPE_DRAIN_TIMEOUT=(not set)'
[ -n \"\$NAC_TEST_QUEUE_SIZE\" ] && echo \"NAC_TEST_QUEUE_SIZE=\$NAC_TEST_QUEUE_SIZE\" || echo 'NAC_TEST_QUEUE_SIZE=(not set)'
[ -n \"\$NAC_TEST_MEMORY_LIMIT_MB\" ] && echo \"NAC_TEST_MEMORY_LIMIT_MB=\$NAC_TEST_MEMORY_LIMIT_MB\" || echo 'NAC_TEST_MEMORY_LIMIT_MB=(not set)'
[ -n \"\$NAC_TEST_BATCH_SIZE\" ] && echo \"NAC_TEST_BATCH_SIZE=\$NAC_TEST_BATCH_SIZE\" || echo 'NAC_TEST_BATCH_SIZE=(not set)'
[ -n \"\$NAC_TEST_BATCH_TIMEOUT\" ] && echo \"NAC_TEST_BATCH_TIMEOUT=\$NAC_TEST_BATCH_TIMEOUT\" || echo 'NAC_TEST_BATCH_TIMEOUT=(not set)'
