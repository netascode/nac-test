...
"""Auto-generated PyATS job file for device P3-E1"""
...
DEVICE_INFO = {
    ...
    "os": "iosxe",
    "device_id": "P3-E1",
    "command": "python /Users/oboehmer/Documents/DD/nac-test/tests/integration/mocks/mock_unicon.py iosxe --hostname P3-E1",
    "username": "admin",
    "password": "admin",
}
