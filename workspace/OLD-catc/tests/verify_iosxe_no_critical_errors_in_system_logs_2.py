...
TITLE = "Verify No Critical Errors in System Logs 1"
                ...
                for log in log_lines:
                    ...
                    if severity == 3:
                        ...
                        if err_sig_match:
                            ...
                            sig = re.sub(
                                r"(\d+\.\d+\.\d+\.\d+)|(\bGi\d+/\d+/\d+\b)|(\bTe\d+/\d+/\d+\b)|(\bEth\d+/\d+/\d+\b)",
                                "<REDACTED>",
                                sig,
                            )
                        else:
