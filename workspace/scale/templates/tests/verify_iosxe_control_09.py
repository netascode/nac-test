...
TITLE = "Verify All SD-WAN Control Connections Are Up (09)"
...
class VerifySdwanControlConnectionsState09(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_09(self, steps):
