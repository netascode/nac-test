...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (03)"
...
class VerifySDWANManagerEdgeConfigSync03(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges3",
        "expected_values": {
