...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (10)"
...
class VerifySDWANManagerEdgeConfigSync10(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges10",
        "expected_values": {
