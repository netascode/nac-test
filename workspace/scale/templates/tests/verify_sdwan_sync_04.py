...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (04)"
...
class VerifySDWANManagerEdgeConfigSync04(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges4",
        "expected_values": {
