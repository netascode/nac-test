...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (05)"
...
class VerifySDWANManagerEdgeConfigSync05(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges5",
        "expected_values": {
    ...
    async def verify_item(self, semaphore, client, context):
        ...
        async with semaphore:
            try:
                ...
                items_to_check = []  # trigger failure
