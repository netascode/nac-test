...
TITLE = "Verify All SD-WAN Control Connections Are Up (08)"
...
class VerifySdwanControlConnectionsState08(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_08(self, steps):
