...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (02)"
...
class VerifySDWANManagerEdgeConfigSync02(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges2",
        "expected_values": {
