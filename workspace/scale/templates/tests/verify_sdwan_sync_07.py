...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (07)"
...
class VerifySDWANManagerEdgeConfigSync07(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges7",
        "expected_values": {
