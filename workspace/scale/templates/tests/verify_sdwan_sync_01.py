...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (01)"
...
class VerifySDWANManagerEdgeConfigSync01(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges1",
        "expected_values": {
