...
TITLE = "Verify All SD-WAN Control Connections Are Up (02)"
...
class VerifySdwanControlConnectionsState02(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_02(self, steps):
