...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (06)"
...
class VerifySDWANManagerEdgeConfigSync06(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges6",
        "expected_values": {
