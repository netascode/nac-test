...
TITLE = "Verify All SD-WAN Control Connections Are Up (04)"
...
class VerifySdwanControlConnectionsState04(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_04(self, steps):
