...
TITLE = "Verify All SD-WAN Control Connections Are Up (03)"
...
class VerifySdwanControlConnectionsState03(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_03(self, steps):
