...
TITLE = "Verify All SD-WAN Control Connections Are Up (06)"
...
class VerifySdwanControlConnectionsState06(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_06(self, steps):
