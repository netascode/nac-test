...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (09)"
...
class VerifySDWANManagerEdgeConfigSync09(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges9",
        "expected_values": {
