...
TITLE = "Verify All SD-WAN Control Connections Are Up (07)"
...
class VerifySdwanControlConnectionsState07(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_07(self, steps):
