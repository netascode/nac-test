...
TITLE = "Verify All SD-WAN Control Connections Are Up (01)"
...
class VerifySdwanControlConnectionsState01(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_01(self, steps):
