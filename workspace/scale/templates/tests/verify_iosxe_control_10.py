...
TITLE = "Verify All SD-WAN Control Connections Are Up (10)"
...
class VerifySdwanControlConnectionsState10(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_10(self, steps):
