...
TITLE = "Verify All SD-WAN Control Connections Are Up (05)"
...
class VerifySdwanControlConnectionsState05(IOSXETestBase):
    """
    ...
    @aetest.test
    def test_sdwan_control_connections_state_05(self, steps):
