...
TITLE = "Verify All SD-WAN Edge Configurations Are In-Sync (08)"
...
class VerifySDWANManagerEdgeConfigSync08(SDWANManagerTestBase):
    """
    ...
    TEST_CONFIG = {
        ...
        "api_endpoint": "/dataservice/system/device/vedges8",
        "expected_values": {
