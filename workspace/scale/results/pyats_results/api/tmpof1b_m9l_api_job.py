...
TEST_FILES = [
    "/Users/oboehmer/Documents/DD/nac-test/workspace/scale/templates-single/tests/verify_sdwan_sync.py"
]

def main(runtime):
    """Main job file entry point"""
    # Set max workers
    runtime.max_workers = 5

    # Note: runtime.directory is read-only and set by --archive-dir
    # The output directory is: /Users/oboehmer/Documents/DD/nac-test/workspace/scale/results/pyats_results
